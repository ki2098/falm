...
public:
    ...
    void devL1_Struct3d7p_Jacobi(Matrix<double> &a, Matrix<double> &x, Matrix<double> &b, Matrix<double> &r, Mapper &global, Mapper &pdom, Mapper &map, dim3 &block_dim);
    void devL1_Struct3d7p_SOR(Matrix<double> &a, Matrix<double> &x, Matrix<double> &b, Matrix<double> &r, Mapper &global, Mapper &pdom, Mapper &map, dim3 &block_dim);
    void devL1_Struct3d7p_PBiCGStab(Matrix<double> &a, Matrix<double> &x, Matrix<double> &b, Matrix<double> &r, Mapper &global, Mapper &pdom, Mapper &map, dim3 &block_dim);
    void devL1_Struct3d7p_Solve(Matrix<double> &a, Matrix<double> &x, Matrix<double> &b, Matrix<double> &r, Mapper &global, Mapper &pdom, Mapper &map, dim3 &block_dim) {
        if (type == SolverType::Jacobi) {
            devL1_Struct3d7p_Jacobi(a, x, b, r, global, pdom, map, block_dim);
        } else if (type == SolverType::SOR) {
            devL1_Struct3d7p_SOR(a, x, b, r, global, pdom, map, block_dim);
        } else if (type == SolverType::PBiCGStab) {
            devL1_Struct3d7p_PBiCGStab(a, x, b, r, global, pdom, map, block_dim);
        }
    }
...
protected:
    ...
    void devL1_Struct3d7p_JAcobiPC(Matrix<double> &a, Matrix<double> &x, Matrix<double> &b, Mapper &pdom, Mapper &map, dim3 &block_dim);
    void devL1_Struct3d7p_SORPC(Matrix<double> &a, Matrix<double> &x, Matrix<double> &b, Mapper &pdom, Mapper &map, dim3 &block_dim);
    void devL1_Struct3d7p_Precondition(Matrix<double> &a, Matrix<double> &x, Matrix<double> &b, Mapper &pdom, Mapper &map, dim3 &block_dim) {
        if (pc_type == SolverType::Jacobi) {
            devL1_Struct3d7p_JAcobiPC(a, x, b, pdom, map, block_dim);
        } else if (pc_type == SolverType::SOR) {
            devL1_Struct3d7p_SORPC(a, x, b, pdom, map, block_dim);
        }
    }
};
