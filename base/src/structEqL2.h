...
public:
    ...
    void L2Dev_Struct3d7p_Jacobi(Matrix<double> &a, Matrix<double> &x, Matrix<double> &b, Matrix<double> &r, Mapper &global, Mapper &pdom, dim3 block_dim, CPMBase &cpm);
    void L2Dev_Struct3d7p_SOR(Matrix<double> &a, Matrix<double> &x, Matrix<double> &b, Matrix<double> &r, Mapper &global, Mapper &pdom, dim3 block_dim, CPMBase &cpm);
    void L2Dev_Struct3d7p_PBiCGStab(Matrix<double> &a, Matrix<double> &x, Matrix<double> &b, Matrix<double> &r, Mapper &global, Mapper &pdom, dim3 block_dim, CPMBase &cpm);
    void L2Dev_Struct3d7p_Solve(Matrix<double> &a, Matrix<double> &x, Matrix<double> &b, Matrix<double> &r, Mapper &global, Mapper &pdom, dim3 block_dim, CPMBase &cpm) {
...
protected:
    void L2Dev_Struct3d7p_JacobiPC(Matrix<double> &a, Matrix<double> &x, Matrix<double> &b, Mapper &pdom, dim3 block_dim, CPMBase &cpm);
    void L2Dev_Struct3d7p_SORPC(Matrix<double> &a, Matrix<double> &x, Matrix<double> &b, Mapper &pdom, dim3 block_dim, CPMBase &cpm);
    void L2Dev_Struct3d7p_Precondition(Matrix<double> &a, Matrix<double> &x, Matrix<double> &b, Mapper &pdom, dim3 block_dim, CPMBase &cpm) {
...
private:
    void L2Dev_Struct3d7p_JacobiSweepBoundary(Matrix<double> &a, Matrix<double> &x, Matrix<double> &xp, Matrix<double> &b, Mapper &pdom, CPMBase &cpm, uint3 *boundary_shape, uint3 *boundary_offset) {
    ...
    void L2Dev_Struct3d7p_SORSweepBoundary(Matrix<double> &a, Matrix<double> &x, Matrix<double> &b, double omega, unsigned int color, Mapper &pdom, CPMBase &cpm, uint3 *boundary_shape, uint3 *boundary_offset) {
        if (cpm.neighbour[0] >= 0) {
            Mapper emap(boundary_shape[0], boundary_offset[0]);
