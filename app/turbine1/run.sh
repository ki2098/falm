...
#PJM -j
#PJM -X
#PJM -o "turbine1.480x200x200.2.log"

module load nvhpc/nvhpc_20.11

date

mpirun -np 2 --map-by ppr:2:socket -display-devel-map -display-devel-map --mca btl_smcuda_use_cuda_ipc 0 --mca plm_rsh_agent /bin/pjrsh -machinefile ${PJM_O_NODEINF} ./bin/t1 small
