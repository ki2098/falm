...
mpirun -np 4 --bind-to core --map-by ppr:2:socket  --report-bindings --mca plm_rsh_agent --mca mpi_leave_pinned 0 /bin/pjrsh -machinefile ${PJM_O_NODEINF} ./bin/t1 weak/4
