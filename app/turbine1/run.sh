...
#PJM -j
#PJM -X
#PJM -o "turbine1.480x200x200.4.ipc.log"

module load nvhpc/nvhpc_20.11

date

mpirun -np 4 --map-by ppr:2:socket -display-devel-map -display-devel-map --mca plm_rsh_agent /bin/pjrsh -machinefile ${PJM_O_NODEINF} ./bin/t1 small
