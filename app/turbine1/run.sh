...
mpirun -np 4 --map-by ppr:2:socket --bind-to core --report-bindings --mca mpi_leave_pinned 0 --mca plm_rsh_agent /bin/pjrsh -machinefile ${PJM_O_NODEINF} ./bin/t1 weak/4
